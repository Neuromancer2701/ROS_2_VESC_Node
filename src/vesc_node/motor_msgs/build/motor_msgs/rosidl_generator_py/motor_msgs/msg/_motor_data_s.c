...
bool motor_msgs__msg__motor_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "motor_msgs.msg._motor_data.MotorData",
        full_classname_dest, 36) == 0);
  }
  motor_msgs__msg__MotorData * ros_message = _ros_message;
  {  // current
...
PyObject * motor_msgs__msg__motor_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_msgs.msg._motor_data");
